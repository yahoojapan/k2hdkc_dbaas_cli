...
while [ $# -ne 0 ]; do
	...
	elif [ "X$1" = "X-os" ] || [ "X$1" = "X-OS" ] || [ "X$1" = "X--ostype" ] || [ "X$1" = "X--OSTYPE" ]; then
	...
	elif [ "X$1" = "X-f" ] || [ "X$1" = "X-F" ] || [ "X$1" = "X--ostype-vars-file" ] || [ "X$1" = "X--OSTYPE-VARS-FILE" ]; then
	...
	elif [ "X$1" = "X-p" ] || [ "X$1" = "X-P" ] || [ "X$1" = "X--force-publish" ] || [ "X$1" = "X--FORCE-PUBLISH" ]; then
	...
	elif [ "X$1" = "X-np" ] || [ "X$1" = "X-NP" ] || [ "X$1" = "X--not-publish" ] || [ "X$1" = "X--NOT-PUBLISH" ]; then
		if [ "X${OPT_IS_FORCE_PUBLISH}" != "X" ]; then
			echo "[ERROR] ${PRGNAME} : already set \"--force-publish(-p)\" or \"--not-publish(-np)\" option."
			exit 1
		fi
	...
	elif [ "X$1" = "X-num" ] || [ "X$1" = "X-NUM" ] || [ "X$1" = "X--build-number" ] || [ "X$1" = "X--BUILD-NUMBER" ]; then
	...
	elif [ "X$1" = "X-devname" ] || [ "X$1" = "X-DEVNAME" ] || [ "X$1" = "X--developer-fullname" ] || [ "X$1" = "X--DEVELOPER-FULLNAME" ]; then
	...
	elif [ "X$1" = "X-devmail" ] || [ "X$1" = "X-DEVMAIL" ] || [ "X$1" = "X--developer-email" ] || [ "X$1" = "X--DEVELOPER-EMAIL" ]; then
	...
	elif [ "X$1" = "X-usepc" ] || [ "X$1" = "X-USEPC" ] || [ "X$1" = "X--use-packagecloudio-repo" ] || [ "X$1" = "X--USE-PACKAGECLOUDIO-REPO" ]; then
	...
	elif [ "X$1" = "X-notpc" ] || [ "X$1" = "X-NOTPC" ] || [ "X$1" = "X--not-use-packagecloudio-repo" ] || [ "X$1" = "X--NOT-USE-PACKAGECLOUDIO-REPO" ]; then
		if [ "X${OPT_USE_PC_REPO}" != "X" ]; then
			echo "[ERROR] ${PRGNAME} : already set \"--use-packagecloudio-repo(-usepc)\" or \"--not-use-packagecloudio-repo(-notpc)\" option."
			exit 1
		fi
	...
	elif [ "X$1" = "X-pctoken" ] || [ "X$1" = "X-PCTOKEN" ] || [ "X$1" = "X--packagecloudio-token" ] || [ "X$1" = "X--PACKAGECLOUDIO-TOKEN" ]; then
	...
	elif [ "X$1" = "X-pcowner" ] || [ "X$1" = "X-PCOWNER" ] || [ "X$1" = "X--packagecloudio-owner" ] || [ "X$1" = "X--PACKAGECLOUDIO-OWNER" ]; then
	...
	elif [ "X$1" = "X-pcprepo" ] || [ "X$1" = "X-PCPREPO" ] || [ "X$1" = "X--packagecloudio-publish-repo" ] || [ "X$1" = "X--PACKAGECLOUDIO-PUBLICH-REPO" ]; then
	...
	elif [ "X$1" = "X-pcdlrepo" ] || [ "X$1" = "X-PCDLREPO" ] || [ "X$1" = "X--packagecloudio-download-repo" ] || [ "X$1" = "X--PACKAGECLOUDIO-DOWNLOAD-REPO" ]; then
...
if [ ${USE_PC_REPO} -eq 1 ]; then
	...
	#
	if [ "${IS_OS_CENTOS}" -eq 1 ] || [ "${IS_OS_FEDORA}" -eq 1 ]; then
...
if [ "${IS_PUBLISH}" -eq 1 ]; then
	...
	if [ "${IS_OS_CENTOS}" -eq 1 ]; then
		...
		# For CentOS
		#
		if [ "X${CI_OSTYPE}" = "Xcentos:7" ] || [ "X${CI_OSTYPE}" = "Xcentos:centos7" ] || [ "X${CI_OSTYPE}" = "Xcentos:6" ] || [ "X${CI_OSTYPE}" = "Xcentos:centos6" ]; then
			#
